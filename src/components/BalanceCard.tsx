    ...
    <>
      <style>{`
        @media (max-width: 480px) {
          .bc-root { padding: 16px !important; }
          .bc-balance-num { font-size: 28px !important; }
        }
      `}</style>

      <div className="bc-root sp-card card-hover animate-slide-up" style={{ padding: '24px' }}>
        {/* Header row */}
            ...
            <div>
              <p style={{ margin: 0, fontSize: '13px', color: 'var(--text-secondary)', lineHeight: 1.4 }}>
                ...
                <a
                  ...
                  style={{ color: 'var(--warning)', textDecoration: 'none', fontSize: '13px' }}
                  onMouseEnter={(e) =>
